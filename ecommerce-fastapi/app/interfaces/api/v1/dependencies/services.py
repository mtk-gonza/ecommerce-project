...
from .repositories import get_product_repository, get_user_repository, get_order_repository, get_cart_repository

def get_product_service(product_repository: ProductRepositoryPort = Depends(get_product_repository)) -> ProductService:
...
def get_cart_service(cart_repository: CartRepositoryPort = Depends(get_cart_repository), product_repository: ProductRepositoryPort = Depends(get_product_repository)) -> CartService:
